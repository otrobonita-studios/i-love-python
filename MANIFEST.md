...
generated by Python and say so in their header, **or** they are binary and live
under `generated/` because a header cannot be inserted:

| Artifact | Generated by | Rule |
|---|---|---|
| `generated/k6/load.js` | `loadtest/generate.py` | starts with `// GENERATED` |
